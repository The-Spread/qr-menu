...
export const bakedGoodsMenu = [
  {
    ...
    addOns: [
      {
        addOnName: "French Butter Croissant",
        price: "$3.00",
        showPlusSign: false,
      },
      {
        addOnName: "Pain au Chocolat",
        price: "$3.00",
        showPlusSign: false,
      },
      {
        addOnName: "Maple Pecan Plait",
        price: "$4.20",
        showPlusSign: false,
      },
      {
        addOnName: "Danish Custard Crown",
        price: "$4.50",
        showPlusSign: false,
      },
      {
        addOnName: "Seasonal Specials",
        price: "See Display",
        showPlusSign: false,
      },
    ],
  },
  {
    ...
    addOns: [
      ...
      {
        addOnName: "Cream Cheese with Dill & Chives",
        price: "+$1.30 / $2.60",
        showPlusSign: true,
      },
    ],
...
export const asianMenu = [
  ...
  {
    itemName: "Hyderabad-style Dum Biryani (Limited Portions)",
    vegetarian: false,
    spicy: false,
    recommended: false,
    price: null,
